...
export default function AmbientOrbs() {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* Accent Orb */}
      <div className="absolute bottom-[-20%] left-[20%] w-[50vw] h-[50vw] rounded-full bg-[radial-gradient(circle,rgba(var(--accent-rgb),0.1)_0%,transparent_60%)] blur-[120px] animate-blob animation-delay-4000 mix-blend-screen" />
