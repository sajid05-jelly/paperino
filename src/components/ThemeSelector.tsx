...
export default function ThemeSelector() {
  ...
  return (
    <>
      {/* Floating Controls — bottom-left on mobile, vertically centered on left for desktop */}
      <div className="fixed bottom-5 left-3 top-auto translate-y-0 sm:bottom-auto sm:top-1/2 sm:left-4 md:left-6 sm:-translate-y-1/2 z-[9800] flex flex-col gap-2.5 sm:gap-3">
        ...
        <a
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-green-500/50 hover:bg-green-500/10 w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 overflow-visible"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-4.5 h-4.5 sm:w-5 sm:h-5 text-green-400 group-hover:drop-shadow-[0_0_8px_rgba(34,197,94,0.8)] group-hover:scale-110 transition-all duration-300">
          ...
          {/* Tooltip — desktop only, pointer-events-none so it never affects layout */}
        ...
        <a
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-pink-500/50 hover:bg-pink-500/10 w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 overflow-visible"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-4.5 h-4.5 sm:w-5 sm:h-5 text-pink-400 group-hover:drop-shadow-[0_0_8px_rgba(236,72,153,0.8)] group-hover:scale-110 transition-all duration-300">
        ...
        <button
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-violet-500/50 hover:bg-violet-500/10 w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 text-gray-400 hover:text-white overflow-visible"
        >
          {soundEnabled
            ? <Volume2 className="w-4.5 h-4.5 sm:w-5 sm:h-5 text-violet-400 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
            : <VolumeX className="w-4.5 h-4.5 sm:w-5 sm:h-5 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
          }
        </button>
        ...
        <button
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-violet-500/50 hover:bg-violet-500/10 w-9 h-9 sm:w-11 sm:h-11 md:w-12 md:h-12 text-gray-400 hover:text-white overflow-visible"
        >
          <Palette className="w-4.5 h-4.5 sm:w-5 sm:h-5 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
        </button>
      </div>
