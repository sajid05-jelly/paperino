...
export default function ThemeSelector() {
  ...
  return (
    <>
      {/* Floating Controls — left sidebar, flush to viewport edge */}
      <div className="fixed top-1/2 left-0 -translate-y-1/2 z-[9900] flex flex-col gap-[10px]" style={{ maxWidth: '48px' }}>
