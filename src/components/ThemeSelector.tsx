...
export default function ThemeSelector() {
  ...
  return (
    <>
      {/* Floating Controls — left sidebar, beautifully positioned with safe margin to prevent clipping */}
      <div className="fixed top-1/2 left-3 sm:left-4 md:left-6 -translate-y-1/2 z-[9800] flex flex-col gap-3 md:gap-3.5">
        ...
        <a
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-green-500/50 hover:bg-green-500/10 w-[42px] h-[42px] sm:w-[46px] sm:h-[46px] md:w-[48px] md:h-[48px] overflow-visible"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px] sm:w-5 sm:h-5 text-green-400 group-hover:drop-shadow-[0_0_8px_rgba(34,197,94,0.8)] group-hover:scale-110 transition-all duration-300">
        ...
        <a
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-pink-500/50 hover:bg-pink-500/10 w-[42px] h-[42px] sm:w-[46px] sm:h-[46px] md:w-[48px] md:h-[48px] overflow-visible"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-[18px] h-[18px] sm:w-5 sm:h-5 text-pink-400 group-hover:drop-shadow-[0_0_8px_rgba(236,72,153,0.8)] group-hover:scale-110 transition-all duration-300">
        ...
        <button
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-violet-500/50 hover:bg-violet-500/10 w-[42px] h-[42px] sm:w-[46px] sm:h-[46px] md:w-[48px] md:h-[48px] text-gray-400 hover:text-white overflow-visible"
        >
          {soundEnabled
            ? <Volume2 size={18} className="sm:w-5 sm:h-5 text-violet-400 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
            : <VolumeX size={18} className="sm:w-5 sm:h-5 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
          }
        </button>
        ...
        <button
          ...
          className="group relative bg-black/60 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:border-violet-500/50 hover:bg-violet-500/10 w-[42px] h-[42px] sm:w-[46px] sm:h-[46px] md:w-[48px] md:h-[48px] text-gray-400 hover:text-white overflow-visible"
        >
          <Palette size={18} className="sm:w-5 sm:h-5 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.8)] transition-all duration-300" />
        </button>
      </div>
