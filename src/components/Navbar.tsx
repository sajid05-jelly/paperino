        ...
        <div className="mx-auto flex max-w-[1600px] w-full items-center justify-between px-3 sm:px-4 lg:px-6 py-2.5 lg:py-3 xl:py-4 gap-2 lg:gap-4">
          ...
          <div className="flex items-center justify-end gap-2 lg:gap-3 flex-shrink-0">
            ...
            <div className="flex sm:hidden items-center gap-1.5 bg-white/5 border border-white/10 rounded-full p-1 backdrop-blur-md mr-1">
              ...
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-[15px] h-[15px] drop-shadow-[0_0_4px_rgba(34,197,94,0.4)]">
              ...
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-[14px] h-[14px] drop-shadow-[0_0_4px_rgba(236,72,153,0.4)]">
              ...
              >
                {soundEnabled
                  ? <Volume2 size={14} className="drop-shadow-[0_0_4px_rgba(139,92,246,0.4)]" />
                  : <VolumeX size={14} />
                }
              </button>
              ...
              <button
                ...
                className="w-7 h-7 rounded-full flex items-center justify-center text-violet-400 hover:text-violet-300 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
              >
                <Palette size={14} className="drop-shadow-[0_0_4px_rgba(139,92,246,0.4)]" />
              </button>
            </div>
