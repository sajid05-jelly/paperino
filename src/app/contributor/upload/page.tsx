        ...
        <div className="lg:col-span-2 glass-panel p-8 rounded-3xl border border-white/5 space-y-6">
          ...
          <form onSubmit={handleUpload} className="space-y-6">
            ...
            <div>
              ...
              <div className={`border-2 border-dashed ${file ? 'border-fuchsia-500 bg-fuchsia-500/10' : 'border-white/10 hover:border-fuchsia-500/40'} rounded-2xl p-8 text-center transition-all cursor-pointer`} onClick={() => document.getElementById("fileUpload")?.click()}>
