    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-6">
      <div className="glass-panel p-8 rounded-2xl max-w-md w-full text-center relative overflow-hidden">
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-black py-3.5 px-6 rounded-2xl font-bold hover:bg-white/90 hover:scale-[1.02] active:scale-[0.98] transition-all relative z-10 shadow-[0_4px_20px_rgba(255,255,255,0.1)] cursor-pointer"
        >
