      ...
      <section className="w-full max-w-6xl mx-auto mb-24">
        <div className="flex flex-col items-center justify-center text-center mb-10">
          ...
          <p className="text-gray-400 text-sm md:text-base mt-2 max-w-lg">
            Select your university to access department courses, study materials, and past exam papers.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full place-items-stretch">
              {loading ? (
                ...
                <div className="text-gray-400 py-16 text-center col-span-full">
                  No approved courses available yet for SRM University.
                </div>
              ) : (
